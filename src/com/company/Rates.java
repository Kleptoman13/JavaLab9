...
public class Rates {
    public ArrayList<Currency> getRates() {return rates;}
    ...
    public void setRates(ArrayList<Currency> rates) {this.rates = rates;}
    ...
    public void add(Currency currency) {this.rates.add(currency);}
